...
初始化之后,lua_State栈的情况:  
![lua_State栈的情况](/images/lua-stack-1.png)
...
![栈的情况2](/images/lua-stack-2.png)

lua_newtable(L)之后,栈的情况:  
![栈的情况3](/images/lua-stack-3.png)
...
![栈的情况4](/images/lua-stack-4.png)

第二个lua_pushglobaltable(L)之后:  
![栈的情况5](/images/lua-stack-5.png)

lua_setfield(L, -2, "_G")之后:  
![lua-stack-6](/images/lua-stack-6.png)

luaL_setfuncs(L, base_funcs, 0)之后:  
![lua-stack-7](/images/lua-stack-7.png)

lua_pushliteral(L, LUA_VERSION)之后:  
![lua-stack-8](/images/lua-stack-8.png)

lua_setfield(L, -2, "_VERSION")  
![lua-stack-9](/images/lua-stack-9.png)
